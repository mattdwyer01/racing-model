...
|:---------|--------:|-----------------:|:---------------------|---------------:|:-------------------|
| 2023 H1  |    5012 |          -0.0028 | -0.0048 to -0.0008   |        -0.0033 | -0.0058 to -0.0010 |
| 2023 H2  |    5233 |           0.0001 | -0.0019 to +0.0020   |        -0.0002 | -0.0026 to +0.0022 |
| 2024 H1  |    5145 |          -0.0016 | -0.0029 to -0.0002   |        -0.0021 | -0.0039 to -0.0002 |
| 2024 H2  |    5229 |          -0.0010 | -0.0023 to +0.0003   |        -0.0015 | -0.0033 to +0.0003 |
| 2025 H1  |    5065 |          -0.0011 | -0.0026 to +0.0005   |        -0.0013 | -0.0033 to +0.0008 |
| 2025 H2  |    5153 |          -0.0012 | -0.0027 to +0.0004   |        -0.0005 | -0.0025 to +0.0015 |
| 2026 H1  |    4992 |          -0.0002 | -0.0016 to +0.0013   |        -0.0002 | -0.0019 to +0.0014 |
| 2026 H2  |    1992 |          -0.0014 | -0.0035 to +0.0009   |        -0.0017 | -0.0043 to +0.0007 |
...
| prodmu blend logit (per state) - prodmu blend logit (pooled weights)     | all     | 37821 | -0.0002 |  -0.0005 |   0.0003 |                  0.4998 |
| prodmu blend logit (per state) - prodmu blend logit (pooled weights)     | QLD     | 16991 |  0.0009 |   0.0002 |   0.0015 |                  0.5326 |
...
| 2023 H2  |    5233 |                                                         0.0005 | -0.0020 to +0.0031                                                 |                                                       0.0002 | -0.0028 to +0.0028                                               |
| 2024 H1  |    5145 |                                                        -0.0013 | -0.0028 to +0.0001                                                 |                                                      -0.0018 | -0.0037 to +0.0000                                               |
| 2024 H2  |    5229 |                                                        -0.0017 | -0.0033 to -0.0002                                                 |                                                      -0.0022 | -0.0041 to -0.0003                                               |
| 2025 H1  |    5065 |                                                        -0.0011 | -0.0029 to +0.0006                                                 |                                                      -0.0015 | -0.0036 to +0.0005                                               |
| 2025 H2  |    5153 |                                                        -0.0020 | -0.0038 to -0.0004                                                 |                                                      -0.0014 | -0.0035 to +0.0006                                               |
| 2026 H1  |    4992 |                                                        -0.0005 | -0.0021 to +0.0012                                                 |                                                      -0.0006 | -0.0024 to +0.0012                                               |
| 2026 H2  |    1992 |                                                        -0.0015 | -0.0040 to +0.0010                                                 |                                                      -0.0019 | -0.0047 to +0.0009                                               |
...
| prodmu blend logit - baseline blend logit | QLD     | 16991 | -0.0007 |  -0.0011 |  -0.0003 |                  0.5236 |
...
| prodmu model logit - baseline model logit | QLD     | 16991 | -0.0103 |  -0.0129 |  -0.0080 |                  0.5261 |
| prodmu model logit - baseline model logit | VIC/SA  | 20830 | -0.0077 |  -0.0101 |  -0.0054 |                  0.5170 |
...
|:---------|--------:|--------------------------------------------:|:------------------------------------------------|
| 2023 H1  |    5012 |                                     -0.0005 | -0.0013 to +0.0004                              |
| 2023 H2  |    5233 |                                     -0.0003 | -0.0012 to +0.0006                              |
| 2024 H1  |    5145 |                                     -0.0005 | -0.0012 to +0.0002                              |
| 2024 H2  |    5229 |                                     -0.0005 | -0.0013 to +0.0002                              |
| 2025 H1  |    5065 |                                     -0.0002 | -0.0010 to +0.0005                              |
| 2025 H2  |    5153 |                                      0.0007 | -0.0000 to +0.0014                              |
| 2026 H1  |    4992 |                                     -0.0000 | -0.0005 to +0.0005                              |
| 2026 H2  |    1992 |                                     -0.0003 | -0.0012 to +0.0006                              |
...
|-----:|-------------------:|:---------------------------|------------------------:|---------------------------:|-------------------:|-------------------:|------------------------:|------------------------:|---------------------------:|---------------------------:|-----------------:|-----------------:|----------------------:|----------------------:|-------------------------:|-------------------------:|
| 2023 |              1.189 | 09 Oct 2022 to 31 Dec 2022 |                   1.225 |                      1.166 |              0.152 |              1.089 |                   0.263 |                   1.048 |                      0.050 |                      1.133 |            0.186 |            1.061 |                 0.288 |                 1.021 |                    0.093 |                    1.103 |
| 2024 |              1.111 | 15 Jul 2023 to 31 Dec 2023 |                   1.151 |                      1.081 |              0.101 |              1.042 |                   0.158 |                   1.032 |                      0.024 |                      1.065 |            0.140 |            1.011 |                 0.195 |                 0.998 |                    0.066 |                    1.037 |
| 2025 |              1.159 | 25 Apr 2024 to 31 Dec 2024 |                   1.174 |                      1.146 |              0.118 |              1.075 |                   0.179 |                   1.038 |                      0.048 |                      1.114 |            0.150 |            1.048 |                 0.206 |                 1.013 |                    0.088 |                    1.085 |
| 2026 |              1.119 | 09 Jan 2025 to 31 Dec 2025 |                   1.112 |                      1.125 |              0.108 |              1.045 |                   0.171 |                   0.988 |                      0.051 |                      1.091 |            0.120 |            1.033 |                 0.186 |                 0.971 |                    0.060 |                    1.083 |
